...
public class Hooks_Hotel1 extends UtilityFiles1 {
	...
	public static void Search_Hotel() {
		...
		sendKeys(objManager.getSearch().getCheck_Out_Date(), "14/09/2022");
	...
	public static void select_Hotel() throws InterruptedException {
