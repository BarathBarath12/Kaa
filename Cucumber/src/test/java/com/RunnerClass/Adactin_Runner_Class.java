...
@CucumberOptions(features = "C:\\Users\\barat\\eclipse-workspace-4\\Cucumber\\Feature\\Adactin.feature", glue = "com.Adactin.Setp.Def", monochrome = true, dryRun = false, publish = true, 
tags = ("not @Ad2 and not @Ad3"), 
plugin = {
